...
class Test extends runtime.Component {
  instance() {
    let test = runtime.variable(this.$props.test);
    runtime.onMount(() => {
      console.log('Mounted');
    });
    runtime.onRender(() => {
      return this.createElement('div', null, this.createElement('div', null, "						This is inside a nested component.					"), test, this.createElement('br', null), test, this.createElement('br', null), this.condition([test], vars => {
        return vars[0] >= 10 && vars[0] <= 100 ? this.createElement('h1', null, "Reactivity Test ", test, this.condition([test], vars => {
          return vars[0] >= 30 && vars[0] <= 50 || vars[0] >= 70 && vars[0] <= 100 ? this.createElement('h1', null, "Bruh") : null;
...
class App extends runtime.Component {
  async instance() {
    let test = runtime.variable(1);
    let color = runtime.variable('color: blue;');
    runtime.variable(this.createElement('p', null, "Test2"));
    let array = runtime.variable(["arraytest", "test2"]);
    let object = runtime.variable({
      test: {
        test: {
          bruh: "bruh"
        }
    ...
    let interval = runtime.variable(setInterval(() => {
    ...
    runtime.onRender(() => {
      ...
      return this.createElement('div', { id: "app",  style: "text-align:center;", }, this.createElement('style', null, styles), this.createElement('div', { style: "width:100%;text-align:center;height:50px;text-align:center;box-shadow: 0px 0px 18px 3px rgba(0,0,0,0.55);margin-bottom:20px;", }, this.createElement('p', { style: "height:100%;", }, "Header")), this.createElement('h1', { onClick: testFn, }, "Click me!"), this.createElement('br', null), this.createElement('br', null), this.createElement('br', null), this.createElement('h1', null, runtime.usable(color)), this.createElement('br', null), this.createElement('br', null), this.createElement('br', null), this.createElement('h2', { class: "test",  style: color, }, "Test ", test, "... ", this.createElement('span', null, test)), test, this.createElement('br', null), test >= 10 && this.createElement('h2', null, "							bruhxdddd						"), test >= 10 && test <= 100 && this.createElement('h1', null, "Reactivity Test ", test, test >= 30 && test <= 50 || test >= 70 && test <= 100 && this.createElement('h1', null, "Conditional 2"), this.foreach(array, item => {
        return this.createElement('h1', null, item);
      }), this.createElement('br', null)), this.createElement(Test, { test: test, }), test, this.createElement('br', null), test, this.createElement('br', null), test, this.createElement('br', null), test, this.createElement('br', null), test, this.createElement('br', null));
    });
    this.test43();
  }
  async test43() {
